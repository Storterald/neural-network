...
template<> void _math_normal<MATH_NORMAL>::sum(
        uint32_t           size,
        const float        first[],
        const float        second[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::sub(
        uint32_t           size,
        const float        first[],
        const float        second[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::mul(
        uint32_t           size,
        const float        first[],
        const float        second[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::div(
        uint32_t           size,
        const float        first[],
        const float        second[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::tanh(
        uint32_t           size,
        const float        data[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::tanh_derivative(
        uint32_t           size,
        const float        data[],
        float              result[]) {
        ...
        _math_normal<MATH_NORMAL>::tanh(size, data, result);
        for (uint32_t i = 0; i < size; ++i) {
                const float x = data[i];
...
template<> void _math_normal<MATH_NORMAL>::ReLU(
        uint32_t           size,
        const float        data[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::ReLU_derivative(
        uint32_t           size,
        const float        data[],
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::min(
        uint32_t           size,
        const float        data[],
        float              min,
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::max(
        uint32_t           size,
        const float        data[],
        float              max,
        float              result[]) {
...
template<> void _math_normal<MATH_NORMAL>::clamp(
        uint32_t           size,
        const float        data[],
        float              min,
        float              max,
...
template<> void _math_normal<MATH_NORMAL>::compare(
        uint32_t           size,
        const float        first[],
        const float        second[],
        bool               *result) {
...
template<> void _math_normal<MATH_NORMAL>::matvec_mul(
        uint32_t           width,
        uint32_t           height,
        const float        matrix[],
        const float        vector[],
