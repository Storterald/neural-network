...
namespace Math {
        ...
        void sum(uint32_t size, const float data[], float scalar, float result[]);
        void sub(uint32_t size, const float data[], float scalar, float result[]);
        void mul(uint32_t size, const float data[], float scalar, float result[]);
        void div(uint32_t size, const float data[], float scalar, float result[]);
        void tanh(uint32_t size, const float data[], float result[]);
        void tanh_derivative(uint32_t size, const float data[], float result[]);
        void ReLU(uint32_t size, const float data[], float result[]);
        void ReLU_derivative(uint32_t size, const float data[], float result[]);
        ...
        void matvec_mul(uint32_t width, uint32_t height, const float matrix[], const float vector[], float result[]);
